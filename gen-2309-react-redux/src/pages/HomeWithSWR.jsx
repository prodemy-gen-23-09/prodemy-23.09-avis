...
// import { setProducts, addToCart, confirmWishlist } from '../actions'; // replace '../actions' with the actual path to your actions file
...
//       <div className="flex justify-center gap-4 pt-5">
//          <button className="rounded-lg bg-sky-400 p-2 text-white self-center"onClick={() => navigate("/redux")} 
//             > Wishlist
//           </button>
//       </div>
