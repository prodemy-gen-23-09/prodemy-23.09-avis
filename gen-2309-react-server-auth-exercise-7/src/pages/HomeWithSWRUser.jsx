...
import { setProducts } from './CartAuthSlice';
import Modal from 'react-modal';

Modal.setAppElement('#root');


function HomeWithSWRUser() {
    ...
    <section className="flex flex-col justify-center">
      ...
      <div className="flex justify-center gap-4 pt-5">
         <button className="rounded-lg bg-sky-400 p-2 text-white self-center"onClick={() => navigate("/shop")} 
          ...
          <button className="rounded-lg bg-sky-400 p-2 text-white self-center"onClick={() => navigate("/receiptuser")} 
            > Receipt
          </button>
      </div>
...
export default HomeWithSWRUser;