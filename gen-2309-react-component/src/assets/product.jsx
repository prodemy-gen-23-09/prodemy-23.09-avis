...
export function Products(props){
    return (
        <div className='productList flex justify-center items-center h-full'>
            <div key={props.id} className='productCard bg-blue-200 relative pb-10 pt-10 p-4 w-80 h-full flex flex-col max-w-md transition duration-200 transform hover:scale-105'>
