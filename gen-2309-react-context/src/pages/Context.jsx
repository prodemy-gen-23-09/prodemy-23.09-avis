...
function App() {
      ...
      <ProductsContext.Provider value={products}>
        <CartContext.Provider value={{ cart, addToCart }}>
          <div className="container mx-auto px-4">
            <Shop confirmWishlist={confirmWishlist} wishlistConfirmed={wishlistConfirmed} />
          </div>
  ...
  function Shop({ confirmWishlist, wishlistConfirmed }) {
  ...
  return (
    <div className='flex'>
      ...
      <div className="w-1/3 pl-4 bg-grey-100">
        ...
        <button onClick={confirmWishlist} className="bg-green-500 text-white px-4 py-2 rounded mt-4">Confirm Wishlist</button>
        {wishlistConfirmed && (
          <div>
